...
// This has been modified to include a structure for the decay parameters.
// Modified by: Jonathan Baltazar
...
// These have been changed from to original code to nu-fit 5, with SK: 
// http://www.nu-fit.org/?q=node/228#label10
double s12sq = 0.304;
double s23sq = 0.573;
double s13sq = 0.02219;
double delta = 197 * M_PI / 180;
double Dmsq21 = 7.42e-5; // eV^2
double Dmsq31 = +2.517e-3; // eV^2
...
// Benchmark m1 has been changed from 0eV to 0.01eV. 
double g_bm = 1e-6;
decay_params dp_bm{0.01, g_bm, g_bm, g_bm, g_bm, g_bm, g_bm, 1e6, 2, 1, true, nu2nu_and_nu2nubar};

mix_params mp_bm = {0.31, 0.558, 0.02241, 222 * M_PI / 180,  7.39e-5, +2.523e-3};
