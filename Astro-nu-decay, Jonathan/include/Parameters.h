...
// Main struct for the mixing parameters:
struct mix_params{double s12sq, s23sq, s13sq, delta, Dmsq21, Dmsq31;};

extern mix_params mp_bm;

// Structure for the ratios: 
struct Ratio{double Fe, Fmu, Ftau;};
#endif
