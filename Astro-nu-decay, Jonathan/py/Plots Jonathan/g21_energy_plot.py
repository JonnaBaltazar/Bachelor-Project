...
filename = '../../data/Visible_coupling_g21.txt'
...
ax1.set(ylim=(0.29,0.375), xscale="log", title=r"$g^{(')}_{21}=10^{-10}$")
...
ax2.set(ylim=(0.29,0.375), xscale="log", title=r"$g^{(')}_{21}=10^{-6}$")
...
ax3.set(ylim=(0.29,0.375), xscale="log", title=r"$g^{(')}_{21}=10^{-5.5}$")
...
ax4.set(ylim=(0.29,0.375), xscale="log", title=r"$g^{(')}_{21}=10^{-2.5}$")
...
fig.tight_layout()
fig.savefig('../../fig/fig_Jonathan/Visible_coupling_g21.pdf')
plt.show()