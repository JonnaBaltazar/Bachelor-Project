...
filename_0 = '../../data/nu_flux_ratios_block_0_g32.dat'
filename_1 = '../../data/nu_flux_ratios_block_1_g32.dat'
filename_2 = '../../data/nu_flux_ratios_block_2_g32.dat'
...
plt.savefig("../../fig/fig_Jonathan/g32_plot.pdf")
plt.show()