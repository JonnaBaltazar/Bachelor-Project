...
filename = '../../data/Visible_coupling_g31.txt'
...
ax1.set(ylim=(0.2,0.5), xscale="log", title=r"$g^{(')}_{31}=10^{-10}$")
...
ax2.set(ylim=(0.2,0.5), xscale="log", title=r"$g^{(')}_{31}=10^{-6}$")
...
ax3.set(ylim=(0.2,0.5), xscale="log", title=r"$g^{(')}_{31}=10^{-5.5}$")
...
ax4.set(ylim=(0.2,0.5), xscale="log", title=r"$g^{(')}_{31}=10^{-2.5}$")
...
fig.tight_layout()
fig.savefig('../../fig/fig_Jonathan/Visible_coupling_g31.pdf')
plt.show()